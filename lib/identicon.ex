defmodule Identicon do
  ...
  def filter_odd_squares(image) do
    ...
    #filter the grid : for each square in the grid, take the vakue and check if the value is even (remainder == 0)
  ...
  def save_image(identicon, input) do
    File.write("#{input}.png", identicon)
  end
